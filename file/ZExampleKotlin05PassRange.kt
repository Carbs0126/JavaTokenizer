String.isUpperCaseCharAt(index: Int, asciiOnly: Boolean): Boolean {
    val c = this[index]
    // todo 下面的 range 有点问题，第一个 . 被解析为 DotForIdentifier，第二个 . 被解析为 DotForRange
    return if (asciiOnly) c in 'A'..'Z' else c.isUpperCase()
}

var x = 10;

val floatRange = 1.5..3.5   // Float 范围
