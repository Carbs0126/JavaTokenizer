...
public class ExpandableTextView extends TextView{
    ...
    /**
     * get the current cn.carbs.tokenizer.state of ExpandableTextView
     * @return
     *      STATE_SHRINK if in shrink cn.carbs.tokenizer.state
     *      STATE_EXPAND if in expand cn.carbs.tokenizer.state
     */
