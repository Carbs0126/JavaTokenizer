...
public class NumberPickerView extends View {
    ...
    // message's what argument to refresh current cn.carbs.tokenizer.state, used by mHandler
    ...
    // The current scroll cn.carbs.tokenizer.state of the NumberPickerView.
    ...
    private void drawContent(Canvas canvas) {
        ...
        int textColor;
        float textSize;
        float fraction = 0f;// fraction of the item in cn.carbs.tokenizer.state between normal and selected, in[0, 1]
