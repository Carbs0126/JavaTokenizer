        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    /**
     * Saves the cn.carbs.tokenizer.state of the {@code ArrayList} instance to a stream
    ...
    final class ArrayListSpliterator implements Spliterator<E> {
         ...
         * point that we need to commit to the cn.carbs.tokenizer.state we are checking
